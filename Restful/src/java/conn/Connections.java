...
public class Connections {
	...
	public static Connection getDevConnection() throws Exception{
		...
		HikariConfig config = new HikariConfig();
		 // Configure which instance and what database user to connect with.
		config.setDriverClassName(System.getProperty("com.mysql.jdbc.Driver")); // see appengine-web.xml
		config.setJdbcUrl("jdbc:mysql://localhost:3306/"+System.getProperty("Customer")); // see appengine-web.xml
		config.setUsername(System.getProperty("root")); // see appengine-web.xml
		config.setPassword(System.getProperty("123456")); // see appengine-web.xml
